.. only:: html
    ...
    .. note::
        ...
        Click :ref:`here <sphx_glr_download_examples_02-plot_scalar-bars.py>`     to download the full example code
...
.. rst-class:: sphx-glr-timing
   ...
   **Total running time of the script:** ( 0 minutes  13.288 seconds)
