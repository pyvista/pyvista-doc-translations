.. only:: html
    ...
    .. note::
        ...
        Click :ref:`here <sphx_glr_download_examples_00-load_create-surface-draped.py>`     to download the full example code
...
.. rst-class:: sphx-glr-timing
   ...
   **Total running time of the script:** ( 0 minutes  13.065 seconds)
