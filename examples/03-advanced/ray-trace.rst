.. only:: html
    ...
    .. note::
        ...
        Click :ref:`here <sphx_glr_download_examples_03-advanced_ray-trace.py>`     to download the full example code
    .. rst-class:: sphx-glr-example-title

    .. _sphx_glr_examples_03-advanced_ray-trace.py:
...
.. image:: /examples/03-advanced/images/sphx_glr_ray-trace_001.png
    :alt: ray trace
...
.. _sphx_glr_download_examples_03-advanced_ray-trace.py:
