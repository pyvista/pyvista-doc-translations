...
add_cell_helper(
    pl, f"POLY_VERTEX ({pv.CellType.POLY_VERTEX})", example_cells.PolyVertex(), (0, 1)
)
add_cell_helper(pl, f"LINE ({pv.CellType.LINE})", example_cells.Line(), (0, 2))
add_cell_helper(
    pl, f"POLY_LINE ({pv.CellType.POLY_LINE})", example_cells.PolyLine(), (0, 3)
)
...
add_cell_helper(
    pl, f"POLYGON ({pv.CellType.POLYGON})", example_cells.Polygon(), (1, 2), cpos="xy"
)
add_cell_helper(
    pl, f"PIXEL ({pv.CellType.PIXEL})", example_cells.Pixel(), (1, 3), cpos="xy"
)
